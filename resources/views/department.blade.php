			...
			<div class="row">			  
				<div class="col-lg-6 col-12">
					  <div class="box">
						...
						<!-- /.box-header -->
						<form class="form" action="{{ url('storeDepartment') }}" method="POST">
							<div class="box-body">
								@csrf
								<div class="row">
								  <div class="col-md-12">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control  @error('departmentName') is-invalid @enderror" placeholder="Dpartment Name" name="departmentName">
					  ...
					  <table class="table table-hover">
						...
						<tr>
							...
							<td><span class="glyphicon glyphicon-pencil m-sm-5" title="Edit"></span> 
								<a href="{{ url('destroyDepartment').'/'.$value["department_id_pk"] }}"><span class="glyphicon glyphicon-trash" title="Delete"></span></a>
							</td>
						  </tr>
						@endforeach
					  </table>
