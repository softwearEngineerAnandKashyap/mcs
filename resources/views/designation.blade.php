			...
			<div class="row">			  
				<div class="col-lg-6 col-12">
					  <div class="box">
						...
						<!-- /.box-header -->
						<form class="form" action="{{ url('storeDesignation') }}" method="POST">
							<div class="box-body">
								@csrf
								<div class="row">
								  <div class="col-md-12">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control   @error('designationName') is-invalid @enderror" placeholder="Designation Name" name="designationName">
						...
						@foreach ($list as $key => $value)
							<tr>
								...
								<td>
									...
									<a href="{{ url('destroyDesignation').'/'.$value["designation_id_pk"] }}"><span class="glyphicon glyphicon-trash" title="Delete"></span></a>
								</td>
						  </tr>
						@endforeach
